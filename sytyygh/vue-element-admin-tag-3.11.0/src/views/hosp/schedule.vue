    ...
    methods:{
        ...
        getScheduleRule() {
            hospApi.getScheduleRule(this.page, this.limit, this.hoscode, this.depcode).then(response => {
                this.bookingScheduleList = response.data.data.bookingScheduleRuleList

                this.total = response.data.data.total

                this.scheduleList = response.data.data.scheduleList
                this.baseMap = response.data.data.baseMap
